...
| [![protondex](https://protonswap.com/img/logo.svg)](https://app.metalx.com/dex/)                                                                                                                                | protondex          | [protondex](https://app.metalx.com/dex/)                                                                | [![API Version 1](https://img.shields.io/badge/1-lightgray)](https://docs.metalx.com/dex/what-is-metal-x)                                          |                                                                                                                             |                                                                              |
...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@3.1.63/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@3.1.63/dist/ccxt.browser.js

CDNs are not updated in real-time and may have delays. Defaulting to the most recent version without specifying the version number is not recommended. Please, keep in mind that we are not responsible for the correct operation of those CDN servers.

```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@3.1.63/dist/ccxt.browser.js"></script>
```
